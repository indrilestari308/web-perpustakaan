...
<style>
    ...
    .info-box i { font-size: 14px; flex-shrink: 0; }
...
<form action="{{ route('kepala.petugas.update', $petugas->id) }}" method="POST">
    ...
    <div class="card-box">
        ...
        <div class="card-body-section">
            ...
            <!-- Info password opsional -->
            <div class="info-box">
                <i class="bi bi-info-circle-fill"></i>
                Kosongkan kolom password jika tidak ingin mengubah password petugas.
            </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <span class="input-hint">Minimal 6 karakter jika diisi</span>
                </div>
